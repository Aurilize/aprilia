...
?>
                        <div class="x_panel">
                                ...
                                <div class="clearfix"></div>
                                <div class="container">
<a href="a-st.php" class="btn btn-round btn-primary" style="float: right">Tambah Data</a>
</div>

<div class="container">
<?php
if(isset($_GET['delete_user'])){
$crud->delete_st($_GET['delete_user']);
...
<div class="container">
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        ...
        <?php
  $query = "SELECT * FROM students ORDER BY id_st desc"; 
  $crud->view_st($query);
  ?>
