...
<div class="clearfix"><div class="title">
        <h3 align="center"><b>Daftar Pengajar Perempuan</b></h3>
    </div></div><br />
...
<div class="container">
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        ...
        <?php
  $query = "SELECT * FROM instructors where gender='Perempuan' ORDER BY id_inst desc"; 
...
<br>
<div class="clearfix"><div class="title">
        <h3 align="center"><b>Daftar Siswa Tidak Aktif</b></h3>
    </div></div><br />
...
<div class="container">
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        ...
        <?php
  $query = "SELECT * FROM students where active='Tidak' ORDER BY id_st desc"; 
  $crud->view_st($query);
  ?>
