...
?>
                        <div class="x_panel">
                                ...
                                <div class="clearfix"></div>
                                <div class="container">
<a href="a-course.php" class="btn btn-round btn-primary" style="float: right">Tambah Data</a>
</div>

<div class="container">
<?php
if(isset($_GET['delete_user'])){
$crud->delete_course($_GET['delete_user']);
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        <thead>
            <tr>
                ...
                <th align="center">Nama Kursus</th>
                <th>Deskripsi</th>
                <th>Ubah Data</th>
                <th>Hapus Data</th>
            </tr>
        ...
        <?php
  $query = "SELECT * FROM course ORDER BY id_course desc"; 
  $crud->view_course($query);
  ?>
