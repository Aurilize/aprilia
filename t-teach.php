...
?>
                        <div class="x_panel">
                                ...
                                <div class="clearfix"></div>
                                <div class="container">
<a href="a-teach.php" class="btn btn-round btn-primary" style="float: right">Tambah Data</a>
</div>
...
<div class="container">
    ...
    <table id="example" table class='table table-bordered responsive-utilities jambo_table'>
        ...
        <?php
  $query = "SELECT teach.id_teach, instructors.name_inst, course.name_course 
  FROM teach, instructors, course 
  WHERE teach.id_inst=instructors.id_inst AND teach.id_course=course.id_course
  ORDER BY id_teach desc"; 
  $crud->view_teach($query);
  ?>
